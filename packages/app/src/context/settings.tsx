...
export function resolveFollowup(value: Settings["general"]["followup"] | undefined): Settings["general"]["followup"] {
  return value ?? defaultSettings.general.followup
}
  ...
  init: () => {
    ...
    return {
      ...
      general: {
        ...
        followup: createMemo(() => resolveFollowup(store.general?.followup)),
