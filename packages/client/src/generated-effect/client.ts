...
type Endpoint3_3Request = Parameters<RawClient["server.session"]["session.backgroundJobs"]>[0]
...
const Endpoint3_3 = (raw: RawClient["server.session"]) => (input: Endpoint3_3Input) =>
  raw["session.backgroundJobs"]({ params: { sessionID: input["sessionID"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )
...
type Endpoint3_8Request = Parameters<RawClient["server.session"]["session.pendingInputs"]>[0]
...
type Endpoint3_9Request = Parameters<RawClient["server.session"]["session.goal"]>[0]
...
type Endpoint3_10Request = Parameters<RawClient["server.session"]["session.goal.set"]>[0]
type Endpoint3_10Input = {
  readonly sessionID: Endpoint3_10Request["params"]["sessionID"]
  readonly objective: Endpoint3_10Request["payload"]["objective"]
  readonly status: Endpoint3_10Request["payload"]["status"]
  readonly reason?: Endpoint3_10Request["payload"]["reason"]
}
const Endpoint3_10 = (raw: RawClient["server.session"]) => (input: Endpoint3_10Input) =>
  raw["session.goal.set"]({
    params: { sessionID: input["sessionID"] },
    payload: { objective: input["objective"], status: input["status"], reason: input["reason"] },
  }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )
...
const adaptGroup3 = (raw: RawClient["server.session"]) => ({
  ...
  backgroundJobs: Endpoint3_3(raw),
  get: Endpoint3_4(raw),
  switchAgent: Endpoint3_5(raw),
  switchModel: Endpoint3_6(raw),
  prompt: Endpoint3_7(raw),
  pendingInputs: Endpoint3_8(raw),
  goal: Endpoint3_9(raw),
  setGoal: Endpoint3_10(raw),
